        ...
        <div className="container">
          ...
          <div className="container shadow">
            <div className="row my-3">
              <div className="col-3">
                <img width={100} height={100} src="https://i.ibb.co/my8ppZr/mongodb.jpg" className="card-img-top border-bottom border-2" alt="..."/>
              </div>
              <div className="col-3">
                <img width={100} height={100} src="https://i.ibb.co/yycZncZ/mysql.jpg" className="card-img-top border-bottom border-2" alt="..." />
              </div>
              <div className="col-3">
                <img width={100} height={100} src="https://i.ibb.co/nz3b1G0/python.png" className="card-img-top border-bottom border-2" alt="..." />
              </div>
              <div className="col-3">
                <img width={100} height={100} src="https://i.ibb.co/0JWGRMd/java.jpg" className="card-img-top border-bottom border-2" alt="..." />
              </div>
              <div className="row my-3 justify-content-center">
                <div className="col-3 align-self-center">
                  <img width={100} height={100} src="https://i.ibb.co/n07d4j3/firebase.png" className="card-img-top border-bottom border-2" alt="..." />
                </div>
                <div className="col-3 align-self-center">
                  <img width={100} height={100} src="https://i.ibb.co/tJp3SNC/html5.png" className="card-img-top border-bottom border-2" alt="..." />
                </div>
              </div>
